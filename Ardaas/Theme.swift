...
enum Theme {
    ...
    static let navyTop = Color(red: 24 / 255, green: 38 / 255, blue: 74 / 255) // #18264A
    static let navyBottom = Color(red: 12 / 255, green: 19 / 255, blue: 40 / 255) // #0C1328

    /// Kesri accent — mirrors the asset-catalog AccentColor. #FF9933
    static let kesri = Color(red: 255 / 255, green: 153 / 255, blue: 51 / 255)

    // MARK: Reading layers
    /// Gurmukhi — warm parchment white. #F2EADB
    static let parchment = Color(red: 242 / 255, green: 234 / 255, blue: 219 / 255)
    /// Transliteration — muted sand gold. #D9A868
    static let sand = Color(red: 217 / 255, green: 168 / 255, blue: 104 / 255)
    /// Translation — cool mist blue-grey. #93A0BC
    static let mist = Color(red: 147 / 255, green: 160 / 255, blue: 188 / 255)
